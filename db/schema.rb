...
ActiveRecord::Schema.define(version: 2021_05_28_153847) do
  ...
  create_table "genre_assignments", force: :cascade do |t|
    ...
    t.index ["movie_id"], name: "index_genre_assignments_on_movie_id"
  end
  ...
  add_foreign_key "genre_assignments", "movies"
